...
def artikel(request):
    ...
    url = 'http://localhost:8000/dashboard/api/artikel/list/cfe8f9c3388bdc29eef486a5f08b049ad4d407a3dbade70035d8c021cf10b9a4'
    # basic auth
    user_login = "zulfikar14"
    user_password = "zulfikar14"
